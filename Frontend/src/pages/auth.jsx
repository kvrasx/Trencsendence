...
const intraApiUrl = 'https://api.intra.42.fr/oauth/authorize?client_id=u-s4t2ud-c1875c5f2e6306bab3da45484c4d83553ef06bd9b5478c76476541d74d20ebb6&redirect_uri=http%3A%2F%2F167.99.138.209%2Fapi%2Fauth%2FOAuth&response_type=code'
...
export default function Auth({ setUser }) {
  ...
  const handleOTP = async (e) => {
    e.preventDefault();
    try {
      let res = await axios.post('http://167.99.138.209/api/OTP/verify', {
        username: username,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`http://167.99.138.209/${endpoint}`, payload, { withCredentials: true });
